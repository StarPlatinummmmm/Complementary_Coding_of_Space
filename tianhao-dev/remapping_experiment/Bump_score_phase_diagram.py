...
def bump_score(map_num, z_max, grid_input_stre):
    Place_cell = Place_net(z_min=0, z_max=z_max, map_num=map_num, neuron_num=place_num, place_num=place_num, noise_stre=0.5)# Parameter 1: map_num, Parameter 2: z_max
    ...
    def run_net(indices, loc, input_stre):            
        ...
        Place_cell.step_run(indices, loc=loc, map_index = map_index, input_stre=input_stre, input_g = grid_input_stre*output) # Parameter 3: grid_input_stre
